// components/NewPostsBanner.jsx
import { ArrowUp } from 'lucide-react';

/**
 * Banner component to notify users of new posts
 * @param {number} count - Number of new posts
 * @param {Function} onLoadNew - Callback when user clicks to load new posts
 */
