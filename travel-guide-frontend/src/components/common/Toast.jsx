...
export default function Toast({ message, type = 'success', onClose }) {
  ...
  return (
    <div className="fixed top-4 right-4 z-[99999]" style={{ animation: 'slideIn 0.3s ease-out' }}>
      <div className={`${bgColor} text-white px-6 py-4 rounded-lg shadow-2xl flex items-center space-x-3 min-w-[300px]`}>
        <div className="flex-shrink-0 w-8 h-8 bg-white/20 rounded-full flex items-center justify-center text-xl font-bold">{icon}</div>
